...
class HobowareUtility:
    def __init__(self):
        # Initialize the clasSept_Office_2014_09_18_13_06_47s variables
	...
	'''
        ...
        output_filename = os.path.splitext(filename)[0] + "_extracted" + \
                          os.path.splitext(filename)[1]
        output_filename = os.path.join('extracted', output_filename)
	...
	'''
        ...
        output_filename = os.path.splitext(output_filename)[0] + "_edited" \
                          + os.path.splitext(output_filename)[1]
        output_filename = os.path.join("edited", output_filename)
        output_file = open(output_filename, "wb")
